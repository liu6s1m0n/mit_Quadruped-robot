 ...
 */
  ...
  {
    static_assert(
      T::ColsAtCompileTime == 1 && T::RowsAtCompileTime == 6,
 ...
 */
  ...
  {
    static_assert(
      T::ColsAtCompileTime == 6 && T::RowsAtCompileTime == 6,
 ...
 */
  ...
  {
    static_assert(
      T::ColsAtCompileTime == 4 && T::RowsAtCompileTime == 4,
 ...
 */
/*
      返回的 6x6 矩阵被分成 4 个 3x3 的块：
X = [  R          0  ]
    [ -R·skew(r)  R  ]
vectorToSkewMat(r) 将 3D 向量 r = [rx, ry, rz]
转换为一个反对称矩阵（Skew-Symmetric Matrix）：
skew(r) = [  0   -rz   ry ]
          [  rz    0   -rx ]
          [ -ry   rx    0  ]
*/
  ...
  auto createSXform(
    const Eigen::MatrixBase < T > & R,
    const Eigen::MatrixBase < T2 > & r)
  {
    static_assert(
      T::ColsAtCompileTime == 3 && T::RowsAtCompileTime == 3,
      "Must have 3x3 matrix");
    static_assert(
      T2::ColsAtCompileTime == 1 && T2::RowsAtCompileTime == 3,
 ...
 */
  template < typename T >
  Mat3 < typename T::Scalar > rotInertiaOfBox(
 ...
 */
  template < typename T, typename T2 >
  auto spatialToLinearAcceleration(
    const Eigen::MatrixBase < T > & a,
    const Eigen::MatrixBase < T2 > & v)
  {
    static_assert(
      ...
      "Must have 6x1 vector");
    static_assert(
      T2::ColsAtCompileTime == 1 && T2::RowsAtCompileTime == 6,
      "Must have 6x1 vector");
 ...
 */
    ...
    const Eigen::MatrixBase < T3 > & x)
  {
    ...
    static_assert(
      ...
      "Must have 6x1 vector");
    static_assert(
      T3::ColsAtCompileTime == 1 && T3::RowsAtCompileTime == 3,
      "Must have 3x1 vector");
 ...
 */
  template < typename T, typename T2 >
  auto forceToSpatialForce(
    const Eigen::MatrixBase < T > & f,
    const Eigen::MatrixBase < T2 > & p)
  {
    static_assert(
      T::ColsAtCompileTime == 1 && T::RowsAtCompileTime == 3,
