 ...
 */
  ...
  Mat3 < typename T::Scalar > quaternionToRotationMatrix(
    ...
    static_assert(
      T::ColsAtCompileTime == 1 && T::RowsAtCompileTime == 4,
      "Must have 4x1 quat");
 ...
 */
  ...
  Quat < typename T::Scalar > quatDerivative(
    const Eigen::MatrixBase < T > &q,
 ...
 */
  ...
  Quat < typename T::Scalar > integrateQuat(
    const Eigen::MatrixBase < T > &quat,
    const Eigen::MatrixBase < T2 > &omega,
    T3 dt) {
    static_assert(
      T::ColsAtCompileTime == 1 && T::RowsAtCompileTime == 4,
